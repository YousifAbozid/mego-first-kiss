...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.AttachmentInputSchema.createMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).attachment.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.AttachmentInputSchema.deleteMany.optional()).mutation(async ({ ctx, input }) => checkMutate(db(ctx).attachment.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.AttachmentInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).attachment.findFirst(input as any))),

        findMany: procedure.input($Schema.AttachmentInputSchema.findMany.optional()).query(({ ctx, input }) => checkRead(db(ctx).attachment.findMany(input as any))),
        ...
        count: procedure.input($Schema.AttachmentInputSchema.count.optional()).query(({ ctx, input }) => checkRead(db(ctx).attachment.count(input as any))),
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    count: {
        ...
        useQuery: <T extends Prisma.AttachmentCountArgs, TData = 'select' extends keyof T
            ? T['select'] extends true
            ? number
            : Prisma.GetScalarType<T['select'], Prisma.AttachmentCountAggregateOutputType>
            : number>(
                input?: Prisma.Subset<T, Prisma.AttachmentCountArgs>,
                ...
                TRPCClientErrorLike<AppRouter>
            >;
        useInfiniteQuery: <T extends Prisma.AttachmentCountArgs>(
            input?: Omit<Prisma.Subset<T, Prisma.AttachmentCountArgs>, 'cursor'>,
